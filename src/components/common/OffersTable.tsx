...
import { 
  ...
  IconButton, TablePagination, InputAdornment, Button 
} from '@mui/material';
...
const OffersTable = () => {
  ...
  return (
    <Box sx={{ width: '1180px', height: '750px', margin: 'auto', mt: 4, mb: 2 }}>
  ...
  <Button 
    ...
    sx={{ 
      ...
      '&::after': {
        ...
        width: '100%',
        height: '2px',
        backgroundColor: selectedStatus === 'all' ? 'black' : 'transparent',
      }
    }}
  >
    All
  ...
  <Button 
    ...
    sx={{ 
      ...
      '&::after': {
        ...
        width: '100%',
        height: '2px',
        backgroundColor: selectedStatus === 'accepted' ? 'black' : 'transparent',
      }
    }}
  >
    Accepted
